...
namespace msa { 
	...
	public:
        ...
        void	run(int numDimensions, size_t *globalSize, const size_t *offset = NULL, size_t *localSize = NULL, cl_uint eventsInWaitList_ = 0, const cl_event* eventWaitList_ = NULL, cl_event* runEvent_ = NULL);

        
        cl_int  unbindOpenGLInterOp();

		// some wrappers for above to create the size arrays on the run
		void	run1D(size_t globalSize, const size_t offset = NULL, size_t localSize = 0);
        void	run2D(size_t globalSizeX, size_t globalSizeY, const size_t offset = NULL, size_t localSizeX = 0, size_t localSizeY = 0, cl_uint eventsInWaitList_ = 0, const cl_event* eventWaitList_ = NULL, cl_event* runEvent_ = NULL);

        
		void	run3D(size_t globalSizeX, size_t globalSizeY, size_t globalSizeZ, const size_t offset = NULL, size_t localSizeX = 0, size_t localSizeY = 0, size_t localSizeZ = 0);
